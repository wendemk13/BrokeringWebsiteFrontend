...
const SearchPage = () => {
  ...
  const handleSearch = async (page = 1) => {
    ...
    try {
      ...
      // Add filters that apply to both property types
      ...
      // Add property type specific filters
      if (filters.propertyType === "House") {
        ...
        params.propertyType = "car";
        if (filters.carMake) params.carMake = filters.carMake;
      ...
      const response = await axios.get(
        "http://localhost:5000/api/search/searchProperties",
        { params }
      );
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      handleSearch(1); // Reset to page 1 when filters change
    ...
    <>
      <div className="search-page">
        <div className="hero-search">
          ...
          <h1>
            {filters.propertyType === "car" && t("Find Your Perfect Car")}
            {filters.propertyType === "House" && t("Find Your Perfect Home")}
            {!["car", "House"].includes(filters.propertyType) &&
              t("Find Your Perfect Property")}
          </h1>

          <div className="search-bar-container">
            <div className="search-bar search-bar-mob">
        ...
        <div className="search-content">
          ...
          >
            ...
            <div className="filter-section">
              <h4>
                <FontAwesomeIcon icon={faMoneyBillWave} /> {t(`Listing Type`)}
              </h4>
              <div className="filter-options">
                ...
                <label
                  className={`filter-option ${
                    filters.listingType === "sell" ? "active" : ""
                  }`}
                >
                  <input
                    type="radio"
            ...
            <div className="filter-section">
              <h4>
                <FontAwesomeIcon
                  icon={filters.propertyType === "car" ? faCar : faHome}
                />{" "}
                {t(`Property Type`)}
              </h4>
              <div className="filter-options">
                <label
                  className={`filter-option ${
                    filters.propertyType === "all" ? "active" : ""
                  }`}
                >
                  <input
                    type="radio"
                ...
                <label
                  className={`filter-option ${
                    filters.propertyType === "car" ? "active" : ""
                  }`}
                >
                  <input
                    type="radio"
                ...
                <label
                  className={`filter-option ${
                    filters.propertyType === "House" ? "active" : ""
                  }`}
                >
                  <input
                    type="radio"
            ...
            {filters.propertyType === "car" && (
              <>
                ...
                <div className="filter-section">
                  <h4>
                    <FontAwesomeIcon icon={faCar} /> Car Make
                  </h4>
                  <select
                    name="carMake"
                    value={filters.carMake}
                ...
                <div className="filter-section">
                  <h4>
                    <FontAwesomeIcon icon={faCalendarAlt} /> Year Range
                  </h4>
                  <div className="price-range-display">
                ...
                <div className="filter-section">
                  ...
                  <Slider
                    ...
                    onChange={(value) =>
                      handleRangeChange("mileageRange", value)
                    }
                  />
                </div>
              </>
          ...
          <div className="results-section">
            ...
            {isLoading ? (
              <div className="loading-results">
                ...
                <p>{t(`Searching for properties...`)}</p>
              </div>
                ...
                <div className="results-grid">
                  {searchResults.map((item) => (
                    <div
                      ...
                      onClick={() =>
                        handleViewDetails(item.id, item.propertyType)
                      }
                    >
                      <div>
                        {item.ForSellRent === "Rent" ? (
                          <span className="card-badge-blue">
                            {t(`For Rent`)}
                          </span>
                        ) : (
                          <span className="card-badge-red">
                            {t(`For Sell`)}
                          </span>
                        )}
                      </div>
                      ...
                      <div className="card-image">
                        <img
                          src={`${process.env.REACT_APP_API_URL}/uploads/${item.cover_image}`}
                          alt={item.title}
                        />
                        <div className="property-type-icon">
                          <FontAwesomeIcon
                            icon={item.propertyType === "car" ? faCar : faHome}
                          />
                        </div>
                      </div>
                      <div className="card-details">
                        ...
                        <p className="price">
                          {parseFloat(item.price).toLocaleString()} {t(`ETB`)}
